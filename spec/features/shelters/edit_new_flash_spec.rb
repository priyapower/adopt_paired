...
RSpec.describe "Shelters Update/New Warnings", type: :feature do
  describe "As a visitor" do
    ...
    it "can warn a user when new shelter fields are incomplete and specify the field" do
      ...
      expect(page).to have_content("Shelter Creation Warning: You are missing the a required field: Zip")
      ...
      expect(current_path).to eq('/shelters')
      expect(page).to have_content("Shelter Creation Warning: You are missing the a required fields: Name, Address")
    end
